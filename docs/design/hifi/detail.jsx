...
const GroceryRow = ({ icon, name, seoul, city, mult, hot }) => (
  <div className="row" style={{ padding: "10px 0", borderBottom: "1px solid var(--line)", gap: 12 }}>
    <div style={{ width: 36, height: 36, borderRadius: 10, background: hot ? "#FFE9DC" : "#F0F5F9", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, flexShrink: 0 }}>
      {icon}
    </div>
    <div className="col" style={{ flex: 1, gap: 2 }}>
      <span className="h3" style={{ fontSize: 13 }}>{name}</span>
      <span className="tiny" style={{ fontSize: 11 }}>{seoul} → {city}</span>
    </div>
    <span style={{ fontSize: 13, fontWeight: 800, fontFamily: "Manrope", color: hot ? "#FC6011" : "#52616B" }}>{mult}</span>
  </div>
);
      ...
      <div className="screen-body" style={{ padding: 0, gap: 0 }}>
        <div style={{ padding: "8px 20px 12px" }}>
          <div className="row between" style={{ marginBottom: 14 }}>
            ...
            <div className="col" style={{ alignItems: "center", gap: 0 }}>
              <span className="h3" style={{ fontSize: 14 }}>식비</span>
              <span className="tiny" style={{ fontSize: 10 }}>서울 vs 밴쿠버</span>
            </div>
            <div style={{ width: 36, height: 36, borderRadius: 12, background: "var(--light)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div className="card" style={{ background: "var(--navy)", color: "#fff", padding: 16, borderRadius: 20, border: "none" }}>
            <div className="row between" style={{ marginBottom: 8 }}>
              <span style={{ fontSize: 11, opacity: 0.7, letterSpacing: "0.08em", textTransform: "uppercase", fontWeight: 700 }}>월 예상 식비 (혼합)</span>
            ...
            <div className="row between" style={{ alignItems: "baseline", gap: 4 }}>
              <div className="col gap-4" style={{ flexShrink: 0 }}>
                ...
                <span style={{ fontSize: 18, fontWeight: 700, fontFamily: "Manrope", whiteSpace: "nowrap" }}>45만</span>
              </div>
              <span style={{ fontSize: 28, fontWeight: 800, fontFamily: "Manrope", color: "#FC6011", whiteSpace: "nowrap", flexShrink: 0 }}>↑1.4×</span>
              <div className="col" style={{ alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                <span style={{ fontSize: 11, opacity: 0.6 }}>밴쿠버</span>
                <span style={{ fontSize: 18, fontWeight: 800, fontFamily: "Manrope", whiteSpace: "nowrap" }}>62만</span>
              </div>
            </div>
            <div style={{ height: 4, background: "rgba(255,255,255,0.15)", borderRadius: 2, marginTop: 14, overflow: "hidden" }}>
              <div style={{ width: "70%", height: "100%", background: "#FC6011", borderRadius: 2 }} />
            </div>
            <div className="tiny" style={{ color: "rgba(255,255,255,0.6)", marginTop: 8, fontSize: 10 }}>자취 70% + 외식 30% 가정</div>
          </div>
        </div>
        ...
        <div style={{ padding: "0 20px", overflowY: "auto", flex: 1 }}>
          <div className="row between" style={{ marginBottom: 6, marginTop: 4 }}>
            ...
            <span className="tiny" style={{ fontSize: 10 }}>2 항목</span>
          </div>
          ...
          <div className="row between" style={{ marginBottom: 6, marginTop: 16 }}>
            ...
            <span className="tiny" style={{ fontSize: 10 }}>8 항목</span>
          </div>
          <div className="card" style={{ padding: "2px 14px", borderRadius: 16 }}>
          ...
          <div className="row between" style={{ padding: "16px 4px 18px" }}>
            <div className="col gap-4">
              <span className="tiny" style={{ fontSize: 10 }}>출처</span>
              <span style={{ fontSize: 11, color: "var(--navy)", fontWeight: 600 }}>Statistics Canada</span>
            </div>
            <span className="tiny" style={{ fontSize: 10, color: "var(--orange)", fontWeight: 700 }}>출처 보기 →</span>
          </div>
        </div>
      </div>
    </Phone>
