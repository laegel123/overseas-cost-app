...
const FlagBox = ({ label, color = "#FC6011" }) => (
  <div style={{ width: 24, height: 18, borderRadius: 4, background: color + "20", color, fontSize: 10, fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Manrope" }}>
    {label}
  </div>
);

const FavCard = ({ name, country, mult, multColor, sub, accent }) => (
  <div className="card" style={{ minWidth: 168, padding: 16, borderRadius: 20, background: accent ? "var(--navy)" : "#fff", color: accent ? "#fff" : "var(--navy)", border: accent ? "none" : "1px solid var(--line)", flexShrink: 0 }}>
    <div className="row between" style={{ marginBottom: 10 }}>
      <div style={{ width: 32, height: 24, borderRadius: 5, background: accent ? "rgba(255,255,255,0.15)" : "var(--light)", color: accent ? "#fff" : "var(--navy)", fontSize: 11, fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Manrope" }}>{country}</div>
    ...
    <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginTop: 12 }}>
      <span style={{ fontSize: 24, fontWeight: 800, fontFamily: "Manrope", color: multColor || (accent ? "#FC6011" : "#FC6011"), lineHeight: 1 }}>{mult}</span>
    ...
    <Phone>
      <div className="screen-body" style={{ padding: 0, gap: 0 }}>
        <div style={{ padding: "8px 20px 0" }}>
          <div className="row between" style={{ marginBottom: 16 }}>
            <div className="col gap-4">
              <div className="tiny" style={{ fontSize: 12 }}>안녕하세요 👋</div>
              <div className="h1">어디 가시나요?</div>
            </div>
            <div style={{ width: 40, height: 40, borderRadius: 14, background: "var(--light)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <Icon name="user" size={20} color="#52616B" stroke={2} />
            </div>
          </div>

          <div className="row gap-8" style={{ background: "var(--light)", borderRadius: 14, padding: "12px 14px", marginBottom: 18 }}>
            <Icon name="search" size={18} color="#8A98A0" stroke={2} />
            <span style={{ color: "var(--gray-2)", fontSize: 13, flex: 1 }}>도시 검색 · 한글/영어</span>
        ...
        <div style={{ padding: "0 0 0 20px" }}>
          <div className="row between" style={{ paddingRight: 20, marginBottom: 10 }}>
            <div className="row gap-6" style={{ alignItems: "center" }}>
              ...
              <span className="h2" style={{ fontSize: 16 }}>즐겨찾기</span>
            </div>
            <span className="tiny">전체 보기</span>
          </div>
          <div className="row gap-10 hide-scroll" style={{ overflowX: "auto", paddingBottom: 6, paddingRight: 20 }}>
        ...
        <div style={{ padding: "0 20px", marginTop: 18 }}>
          <div className="row between" style={{ marginBottom: 10 }}>
            <span className="h2" style={{ fontSize: 16 }}>최근 본 도시</span>
          ...
          <div className="col gap-8">
            {[
              ...
              <div key={k} className="card" style={{ padding: "10px 12px", borderRadius: 14, display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{ width: 36, height: 36, borderRadius: 10, background: "var(--light)", color: "var(--navy)", fontSize: 11, fontWeight: 800, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Manrope" }}>{c}</div>
                <div className="col" style={{ flex: 1, gap: 0 }}>
                  <span className="h3" style={{ fontSize: 14 }}>{k}</span>
                  <span className="tiny">{en}</span>
                </div>
                <span style={{ fontSize: 14, fontWeight: 800, color: col, fontFamily: "Manrope" }}>{m}</span>
        ...
        <div style={{ padding: "0 20px", marginTop: 18, marginBottom: 16 }}>
          <span className="h2" style={{ fontSize: 16, display: "block", marginBottom: 10 }}>권역별 탐색</span>
  ...
  return (
    <>
      <div className="screen-intro">
        ...
        <h2>표준 스택 — 즐겨찾기 우선</h2>
        <p>재방문 사용자가 가장 보고 싶은 카드(즐겨찾기)를 가로 스크롤로. 최근 + 검색 + 권역이 자연스럽게 따라붙음.</p>
      </div>
