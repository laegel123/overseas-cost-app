...
const StatusIcons = () => (
  <div className="icons">
    ...
    <svg width="14" height="10" viewBox="0 0 14 10" fill="none">
      <path
        d="M7 2.5C9 2.5 10.7 3.3 12 4.5L13 3.5C11.4 1.9 9.3 1 7 1C4.7 1 2.6 1.9 1 3.5L2 4.5C3.3 3.3 5 2.5 7 2.5Z"
        fill="#11263C"
      />
      <path
        d="M7 5.5C8.2 5.5 9.2 6 10 6.7L11 5.7C9.9 4.7 8.5 4 7 4C5.5 4 4.1 4.7 3 5.7L4 6.7C4.8 6 5.8 5.5 7 5.5Z"
        fill="#11263C"
      />
    ...
    <svg width="22" height="11" viewBox="0 0 22 11" fill="none">
      ...
      <path
        d="M21 3.5V7.5C21.6 7.3 22 6.7 22 5.5C22 4.3 21.6 3.7 21 3.5Z"
        fill="#11263C"
        fillOpacity="0.4"
      />
    </svg>
...
const Icon = ({ name, size = 22, color = 'currentColor', stroke = 1.8 }) => {
  ...
  switch (name) {
    ...
    case 'compare':
      return (
        <svg viewBox="0 0 24 24" {...s}>
          <path d="M5 4v16M5 8l4-4M5 8l4 4M19 20V4M19 16l-4 4M19 16l-4-4" />
        </svg>
      );
    case 'star':
      return (
    ...
    case 'house':
      return (
        <svg viewBox="0 0 24 24" {...s}>
          <path d="M3 11l9-8 9 8v10a1 1 0 0 1-1 1h-16a1 1 0 0 1-1-1z" />
    ...
    case 'fork':
      return (
        <svg viewBox="0 0 24 24" {...s}>
          <path d="M5 3v6a3 3 0 0 0 3 3v9M11 3v6M8 6V3" />
          <path d="M19 3v18M15 7c0-2 2-4 4-4" />
        </svg>
      );
    case 'bus':
      return (
    ...
    case 'book':
      return (
        <svg viewBox="0 0 24 24" {...s}>
          <path d="M4 4a2 2 0 0 1 2-2h13v18H6a2 2 0 0 0 0 4h13" />
        </svg>
      );
    case 'user':
      return (
      ...
      <div key={id} className={'ti' + (active === id ? ' active' : '')}>
        <div className="ic">
          <Icon
            name={icon}
            size={22}
            color={active === id ? '#FC6011' : '#8A98A0'}
            stroke={active === id ? 2.2 : 1.8}
          />
        </div>
        <span>{label}</span>
      </div>
  ...
  <div className="card" style={{ padding: 12, borderRadius: 16 }}>
    <div className="row between" style={{ marginBottom: 8, gap: 8 }}>
      <div className="row gap-8" style={{ flex: 1, minWidth: 0 }}>
        ...
        <span className="h3" style={{ whiteSpace: 'nowrap' }}>
          {label}
        </span>
      </div>
      <span
    ...
    <div className="col gap-6">
      <div className="row gap-8">
        <span className="tiny" style={{ width: 28, color: '#8A98A0', fontWeight: 700 }}>
          SEO
        </span>
        ...
        <span
          style={{ width: 56, textAlign: 'right', fontSize: 11, color: '#52616B', fontWeight: 600 }}
        >
          {sValue}
        </span>
      </div>
      <div className="row gap-8">
        <span className="tiny" style={{ width: 28, color: '#FC6011', fontWeight: 700 }}>
          VAN
        </span>
        <div className="bar-track" style={{ flex: 1 }}>
        ...
        <span
          style={{ width: 56, textAlign: 'right', fontSize: 11, color: '#11263C', fontWeight: 700 }}
        >
          {cValue}
        </span>
      </div>
