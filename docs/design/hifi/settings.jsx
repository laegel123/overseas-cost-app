        ...
        <div style={{ padding: '8px 20px 0' }}>
          ...
          <div
            ...
            style={{
              padding: 18,
              borderRadius: 22,
              background: 'linear-gradient(135deg, #11263C 0%, #1d3a55 100%)',
              color: '#fff',
              border: 'none',
              boxShadow: '0 12px 32px rgba(17,38,60,0.18)',
              position: 'relative',
              overflow: 'hidden',
            }}
          >
            ...
            <div className="row gap-12" style={{ alignItems: 'center' }}>
              <div
                style={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: '0 6px 16px rgba(252,96,17,0.3)',
                }}
              >
                <Icon name="graduation" size={26} color="#fff" stroke={2.2} />
              </div>
              <div className="col gap-4" style={{ flex: 1 }}>
                <span style={{ fontSize: 16, fontWeight: 800, fontFamily: 'Manrope' }}>
                  유학생 모드
                </span>
              ...
              >
                ...
                <span
                  ...
                  style={{
                    fontSize: 13,
                    flex: 1,
                    color: item.dim ? 'var(--gray-2)' : 'var(--navy)',
                  }}
                >
                  {item.label}
                </span>
