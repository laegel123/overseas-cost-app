  ...
  return (
    <Phone>
      <div
        ...
        style={{ padding: '8px 22px 0', justifyContent: 'space-between' }}
      >
        <div className="col gap-12" style={{ marginTop: 24 }}>
          <div
            style={{
              ...
              boxShadow: '0 8px 24px rgba(252,96,17,0.3)',
            }}
          >
          ...
          <div className="col gap-4">
            ...
            <div className="h-display" style={{ fontSize: 30, color: 'var(--orange)' }}>
              어디로 떠나시나요?
            </div>
          </div>
        ...
        <div className="col gap-10" style={{ marginTop: 24 }}>
          ...
          >
            <div className="col" style={{ flex: 1 }}>
              <div className="h3" style={{ color: 'var(--gray)', fontSize: 13 }}>
                아직 모르겠어요
              </div>
